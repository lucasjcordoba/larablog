...
<body>
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img id="card-img" src="{{ asset('storage').'/' .$blog->image}}" class="card-img-top h-100" alt="...">
    ...
    <footer class="footer bg-dark text-secondary px-4 text-center">
        <div class="py-4">
            ...
            <a href="https://www.linkedin.com/in/lucasjcordoba/">
            ...
            <a href="https://github.com/lucasjcordoba">
                <svg id="github" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
